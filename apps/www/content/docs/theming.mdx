---
title: 主题
description: 使用 CSS 变量或 Tailwind CSS 自定义主题。
---

你可以使用 CSS 变量 (推荐) 或 Tailwind CSS utility classes 自定义主题。
...
使用 utility classes 自定义主题请在 `components.json` 文件中将 `tailwind.cssVariables` 设置为 `false`。
